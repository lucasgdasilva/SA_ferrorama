            ...
            <div class="container-login">
                ...
                <?php if (isset($_GET['status'])): ?>
                    ...
                    <?php if ($_GET['status'] === 'senhas_diferentes'): ?>
                        ...
                        <p class="aviso">As senhas não são iguais.</p>

                    <?php elseif ($_GET['status'] === 'email_existente'): ?>

                        <p class="aviso">Este e-mail já está cadastrado.</p>

                    <?php endif; ?>

                <?php endif; ?>

                <form action="cadastrar.php" method="POST" class="formulario-login">
                    ...
                    <input type="password" id="confirmar-senha" name="confirmar-senha" placeholder="Confirmar senha"
                        required />
                    <button type="submit" id="botao-entrar">Cadastrar</button>
                </form>
            </div>
            <div class="retornar">
